...
import {
  ...
  FaPalette, FaServer, FaCloud, FaToolbox
} from 'react-icons/fa';
import {
...
const skillCategories = [
  ...
  {
    title: "Databases",
    icon: <AiOutlineDatabase />, // 🗄️ Data-themed
    skills: [
...
export default function Skills() {
  return (
    <section
      id="skills"
      className="min-h-screen bg-black px-8 py-16 flex flex-col items-center"
    >
